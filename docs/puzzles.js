...
var OWPUZZLES = [
  ...
  },
  {
    ...
    name: 'Over the Hills',
    author: 'owpuzzle',
    brief: 'The archer is four hills away and there is no way around. 6 orders.',
    lesson: 'After 3 movement steps a unit is FATIGUED. It can keep going — a FORCE MARCH — but every extra step costs 2 orders. Attacks still cost only 1 and are never blocked by fatigue.',
    orders: 6,
    radius: 3,
    objective: { kind: 'killAll' },
    tiles: [
