...
var OWPUZZLES = [
  ...
  },
  {
   ...
   "name": "The Last Stand",
   "author": "owpuzzle",
   "brief": "Kill the enemy general.",
   "lesson": "A zealot never falls to the blow itself: any strike that would kill one is cut short, leaving him standing on his last point of health. Only the spill from an attack aimed at somebody ELSE finishes him — so the man beside him must still be alive when the arrow flies.",
   "orders": 4,
   "radius": 3,
   "hero": 1,
   "tiles": [
