...
var OWPUZZLES = [
  ...
  },
  {
    ...
    name: 'The Barrage',
    author: 'owpuzzle',
    brief: 'Kill all three enemies from here. Your onager has 2 orders.',
    lesson: 'Siege engines must SET UP before firing — and their shots ignore distance entirely. The blast SPLASHES all units adjacent to the target for 25%.',
    orders: 2,
    radius: 4,
    objective: { kind: 'killAll' },
    units: [
      { player: 0, type: 'UNIT_ONAGER', q: -3, r: 0 },
      { player: 1, type: 'UNIT_WARRIOR', q: 1, r: 0, hp: 9 },
  ...
  },
  {
    ...
    lesson: 'Horses fear camels: camel riders fight at +50% against anything on a horse. Ride close and shoot point blank — mounted archers take no counterattack.',
    orders: 2,
    radius: 3,
    tiles: [
      { q: -2, r: 0, terrain: 'TERRAIN_SAND' }, { q: -1, r: 0, terrain: 'TERRAIN_SAND' },
      { q: 0, r: 0, terrain: 'TERRAIN_SAND' }, { q: 1, r: 0, terrain: 'TERRAIN_SAND' },
      { q: -1, r: 1, terrain: 'TERRAIN_SAND' }, { q: 0, r: 1, terrain: 'TERRAIN_SAND' },
      { q: -2, r: 1, terrain: 'TERRAIN_ARID' }, { q: 1, r: -1, terrain: 'TERRAIN_ARID' },
      { q: 0, r: -1, terrain: 'TERRAIN_ARID' }, { q: -1, r: -1, terrain: 'TERRAIN_ARID' },
    ],
    objective: { kind: 'killAll' },
    units: [
      { player: 0, type: 'UNIT_CAMEL_ARCHER', q: -2, r: 0 },
      { player: 1, type: 'UNIT_HORSEMAN', q: 1, r: 0, hp: 8 },
    ],
  },
  {
    id: 'trample',
    ...
    name: 'Trample',
    author: 'owpuzzle',
    brief: 'The spearman cannot be killed — but the horseman behind him can. 3 orders.',
    lesson: 'Elephants PUSH: a surviving defender is shoved to the tile behind. You cannot kill everything — sometimes you move the wall aside instead.',
    orders: 3,
    radius: 3,
    ...
    units: [
      ...
      { player: 0, type: 'UNIT_HORSEMAN', q: -2, r: 0 },
      { player: 1, type: 'UNIT_SPEARMAN', q: 0, r: 0 },
      { player: 1, type: 'UNIT_HORSEMAN', q: 2, r: 0, hp: 6, name: 'enemy horseman' },
    ],
  },
  {
    id: 'chop-the-spears',
  ...
  },
  {
    ...
    objective: { kind: 'killAll' },
    units: [
      { player: 0, type: 'UNIT_CROSSBOWMAN', q: -1, r: 0 },
