...
var OWPUZZLES = [
  ...
  // --- Promotion puzzles: the promotion is REQUIRED, not merely available.
  // test/promo-lessons.test.js strips the taught promotion and asserts the
  // objective becomes unreachable at the pool the player actually gets, so the
  // lesson cannot quietly stop being true. The rest of the set is still in
  // drafts/promo/ awaiting a rebuild — they verified, but they played flat.
  {
    ...
    "lesson": "Ranger measures the ground under your own feet, and a rout drops you onto the tile the dead man was standing on \u2014 so the kill that wins this fight is the one that puts you in the trees.",
    "orders": 5,
    "radius": 2,
    "training": 0,
    "objective": {
